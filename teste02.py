# coding=utf-8
# Notas:
#   Transformada Hough é muito espeífica e não robusta
#   O ajuste dospaâmetros é muito sensível para uso geral
#   Não é resolução suficiente para Hough determinar circulos
#     pequenos com certeza, uma vez que afeta grandemente para
#     círculos com diâmetros maiores
